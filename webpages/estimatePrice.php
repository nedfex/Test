...
function estimatePrice($SYMBOL , $CurrentData)
{
		...
		$Avg_BVPS_Growth = $S / $counter; // 先用內定成長率算 
		...
		// 未來PE 計算 :growth *2  forwardPE 現在 PE , fundmental - key ratio 5 year summary 之 5 年平均(5欄位)

		for($i=0;$i<=4;$i++) //key ratio 5 year summary 之 5 年平均(5欄位)
		{
